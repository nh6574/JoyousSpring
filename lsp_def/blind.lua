...
---@field prevent_illusion_banish? fun(self:SMODS.Blind|table, blind:table|Blind?, other_card:table|Card):boolean? Determines if the Illusion Joker *other_card* should banish at the start of Blind
