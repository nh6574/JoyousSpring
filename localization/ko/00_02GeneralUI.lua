return {
	misc = {
		dictionary = {
			...
			k_joy_summon_warning = "기술적 한계때문에 유효하지 않은 소재가 포함 되어 있을 수 있습니다",
			k_joy_select_tributes = "릴리스 선택",
			k_joy_transferred_abilities = "부여된 효과:",
			k_joy_select = "선택",
			k_joy_summon = "소환",
			k_joy_summon_no_space = " (자리 부족)",
			k_joy_detach = "엑시즈",
			k_joy_activate = "발동",
			k_joy_side_deck = "사이드 덱",
			b_joy_to_side_1 = "사이드",
			b_joy_to_side_2 = "덱 으로",
			b_joy_buy_to_side_1 = "사이드 덱",
			b_joy_buy_to_side_2 = "에 넣기",
			--#endregion
			--#region Related cards
			k_joy_related = "관련된",
			k_joy_related_individual = " 카드",
			k_joy_archetype = " 카드군",
