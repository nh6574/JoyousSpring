	...
	descriptions = {
		Joker = {
			...
			j_joy_generaider_vala = {
				...
				text = {
					{
						"소환 시 {C:attention}묘지{}에 {C:red}희귀{} {C:joy_normal}메인 덱",
						'{C:joy_normal}"제너레이드" #1#{}장을 생성합니다',
					},
					{
						"{C:attention}보스 블라인드{}에 승리할 시 파괴되며",
						'{C:red}레어{} {C:joy_spell}"제너레이드"{} {C:attention}#2#{}장을 {C:attention}소생{}시키며',
						'{C:joy_effect}"제너레이드 섀도우 로프톨"{} {C:attention}#1#{}장을 소환합니다',
						"{C:inactive}(자리가 있어야 합니다){}",
					},
				},
			},
				...
				text = {
					{
						...
						"{C:attention}#1#{}장을 {C:attention}릴리스{}해 현재 {C:attention}보스 블라인드{}의",
						"효과를 무효화할 수 있습니다",
					},
				},
			},
				...
				text = {
					{
						...
						'{C:blue}일반{} 또는 {C:green}희귀{} {C:joy_normal}"제너레이드"{}를 생성합니다',
						"{C:inactive}(자리가 있어야 합니다){}",
					},
				},
			},
			...
			j_joy_generaider_jormungandr = {
				...
				joy_summon_conditions = {
					...
					"{s:0.9,C:inactive}({s:0.9,C:joy_xyz}엑시즈{s:0.9,C:inactive}, {s:0.9,C:joy_link}링크{}, {s:0.9,C:joy_token}토큰{s:0.9,C:inactive} 제외)",
				},
			},
			...
			j_joy_generaider_boss_stage = {
				...
				text = {
					{
						'각 {C:joy_normal}"제너레이드"{}가 배수를 부여하며',
						"카드를 {C:attention}릴리스{} 할때 마다",
						"부여량이 {C:mult}+#1#{} 배수를 증가합니다",
						"{C:inactive}(현재 {C:mult}+#2#{}{C:inactive} 배수)",
					},
					{
					...
					{
						'한 라운드에 한 번, {C:joy_token}"제너레이드 토큰"{} {C:attention}#1#{}장을',
						"{C:attention}릴리스{}해 보유하지 않은 {C:red}레어{}",
						'{C:joy_normal}"제너레이드"{} {C:attention}#3#{}장을 생성합니다',
						"{C:inactive}(자리가 있어야 합니다){}",
					},
				},
			},
