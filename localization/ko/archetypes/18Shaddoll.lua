		...
		Joker = {
			...
			j_joy_shaddoll_dragon = {
				...
				text = {
					...
					{
						"{C:joy_effect}리버스{}: 이 라운드 동안 핸드 {C:blue}+#1#{} 번을 얻고,",
						'{C:joy_normal}"섀도르"{} {C:attention}#2#{}장을 {C:attention}소생{}시킨 후',
						'{C:attention}묘지{}에 무작위한 {C:joy_normal}"섀도르"{} {C:attention}#3#{}장을 생성합니다',
					},
					{
				...
				text = {
					{
						...
						"{C:attention}뒤집히지 않고{} 블라인드 선택 시",
						"{C:joy_effect}리버스{} 효과를 발동시킵니다",
					},
					{
						"{C:attention}소재{}로 사용될시 {C:joy_spell}엑스트라 덱{}에",
						'무작위한 {C:joy_normal}"섀도르" {C:attention}#1#{}장을 생성합니다',
			...
			j_joy_shaddoll_prison = {
				...
				text = {
					...
					{
						"이 카드의 {C:joy_token}카운터{} 하나 마다 칩 {C:chips}+#3#{}개를 획득합니다",
						"{C:inactive}(현재 칩 {C:chips}+#4#{C:inactive}개)",
					},
					{
						"이 카드에서 {C:joy_token}카운터{} {C:attention}#5#{}개를 제거해",
						"{C:joy_fusion}융합{} 조커 {C:attention}#6#{}장을 {C:attention}소생{}시킬수 있습니다",
					},
				},
			},
		},
