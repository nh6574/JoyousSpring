return {
	descriptions = {
		Joker = {
			...
			j_joy_hallo = {
				name = "{C:joy_pendulum_normal}할로할로",
				joy_consumable = {
					"모든 {C:attention}조커{}에 기재된 {C:green}확률{}을",
					"{C:attention}#1#{}~{C:attention}#2#{}씩 증가시킵니다",
				},
				text = {
					{
						"{E:1}할로할로는 달콤한 과자만 보면 헤롱헤롱.{}",
						"{E:1}과자를 찾아 이쪽을 두리번, 저쪽에 어슬렁.{}",
						"{E:1}과자를 주지 않으면 가지가지 장난들로",
						"{E:1}흐물흐물하게 만들거야.{}",
						"{E:1} ",
						"{E:1}허둥지둥대봤자 이미 늦었어.",
						"{E:1}무엇이 나올지 기대기대.{}",
			...
			j_joy_metrognome = {
				...
				joy_consumable = {
					"가장 많이 보유한 희귀도의 {C:joy_pendulum}펜듈럼{}",
					"카드 {C:attention}#1#{}장을 무작위로 생성합니다",
					"{C:inactive}(자리가 있어야 합니다)",
					"{C:inactive}(비길경우 무작위 희귀도을 고릅니다)",
				},
				text = {
					{
						"가장 많이 보유한 희귀도의 {C:joy_pendulum}펜듈럼{}",
