	...
	descriptions = {
		Joker = {
			...
			j_joy_ba_dante = {
				...
				text = {
					{
						"{C:attention}묘지{}의 {C:attention}조커{} 한 장마다",
						"{C:mult}+#1#{} 배수를 획득합니다",
						"{C:inactive}(현재{} {C:mult}+#2#{} {C:inactive}배수){}",
					},
					{
						"{C:joy_xyz}엑시즈{} {C:attention}#3#{}: {C:attention}묘지{}에 무작위한",
						"조커 {C:attention}#4#{}장을 생성합니다",
					},
					{
						'{C:joy_normal}"피안"{} 조커가 자기 자신을 파괴하지 않습니다',
					},
			...
			j_joy_ba_virgil = {
				...
				joy_summon_conditions = {
					...
					"{C:joy_synchro}튜너{} 이외의 {C:joy_normal}악마족{} 조커 {C:attention}1{}장",
			...
			j_joy_ba_beatrice = {
				...
				text = {
					...
					{
						'{C:joy_xyz}엑시즈{} {C:attention}#3#{}: {C:joy_normal}"피안"{} 조커를 (없을시 임의의 조커를)',
						"{C:attention}#4#{}장을 {C:dark_edition}네거티브{}를 부여해 {C:attention}소생{}시킵니다",
					},
					{
				...
				joy_summon_conditions = {
					...
					"{s:0.9,C:inactive}({C:joy_xyz}엑시즈{}일경우, 소재를 이 카드로 옮깁니다)",
				},
			},
		},
	},
