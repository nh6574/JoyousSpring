	...
	descriptions = {
		Joker = {
			...
			j_joy_dogma_thunderbolt = {
				name = "{C:joy_effect}드래그마의 뇌정 플루르드리스",
				text = {
					{
						"각 디버프된 {C:joy_spell}엑스트라 덱{} {C:attention}조커{}가",
					...
					{
						"{C:joy_ritual}의식{} 소환의 {C:attention}소재{}로 사용될 시",
						'{C:dark_edition}네거티브{} {C:joy_effect}"드래그마의 뇌정 플루르드리스"를 생성합니다',
					},
					{
						"Free and doesn't need room when obtained from the shop",
						"if you own a debuffed {C:joy_spell}Extra Deck{} {C:attention}Joker{}",
						"디버프된 {C:joy_spell}엑스트라 덱{} {C:attention}조커{}를 보유 시 무료이며",
						"자리를 필요하지 않습니다",
					},
				},
			},
			...
			j_joy_dogma_ashiyan = {
				...
				text = {
					...
					{
						"{C:attention}보스 블라인드{}에 승리 할 시 다음 상점에",
						'{C:joy_ritual}의식{} {C:joy_normal}"도그마티카"{}',
						"카드 {C:attention}#2#{}장을 추가합니다",
					},
					{
						"디버프된 {C:joy_spell}엑스트라 덱{} {C:attention}조커{}를 보유 시 무료",
					},
			...
			j_joy_dogma_albazoa = {
				name = "{C:joy_ritual}드래그마의 알바 조아",
				text = {
					{
						"{C:attention}블라인드{} 선택 시 {C:joy_spell}엑스트라 덱{}에 있는",
						"모든 {C:attention}조커{}를 {C:attention}#1#{}장 복사해 {C:attention}묘지{}에 넣습니다",
					},
					{
						"디버프된 {C:joy_spell}엑스트라 덱{} {C:attention}조커{} 한 장 마다",
						"각 {C:joy_normal}메인 덱{} {C:attention}조커가{} {X:mult,C:white}X#2#{} 배수를 부여합니다",
