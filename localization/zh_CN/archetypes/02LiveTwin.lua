    ...
    descriptions = {
        Joker = {
            ...
            j_joy_etwin_kisikil_lilla = {
                ...
                text = {
                    {
                        "墓地中每张“璃拉”给予{C:chips}+#1#{}筹码",
                        "墓地中每张“姬丝基勒”给予{C:mult}+#2#{}倍率",
        ...
        Blurbs = {
            ltwin = {
                story = {
                    ...
                    "对公众而言，她们是当红主播组合{C:joy_normal}“直播{C:joy_normal,f:joy_font}☆{}{C:joy_normal}双子”{}……但她们的真实身份是美丽的怪盗少女{C:joy_normal}“邪恶{C:joy_normal,f:joy_font}★{}{C:joy_normal}双子”{}！",
                },
                gameplay = {
                    "本主题侧重于基础得分，并通过{C:attention}复活{}循环获取优势，每回合请尽量{C:attention}召唤{}{C:joy_link}“麻烦·桑妮”{}。"
                }
            }
        }
    },
