return {
    descriptions = {
        Joker = {
            j_joy_paleo_canadia = {
                ...
                text = {
                    {
                        "每{C:attention}反转{}1张卡牌获得{C:mult}+#1#{}倍率",
            ...
            j_joy_paleo_lean = {
                ...
                text = {
                    {
                        "每{C:attention}反转{}1张卡牌获得{C:chips}+#1#{}筹码",
                        "{s:0.9,C:inactive}(即使里侧状态也生效)",
            ...
            j_joy_paleo_opa = {
                ...
                joy_summon_conditions = {
                    "{C:attention}2{}张{C:joy_water}水属性{}{C:attention}卡牌{}",
                }
            },
        }
    },
    JoyousSpring = {
        Blurbs = {
            paleo = {
                gameplay = {
                    "这些{C:attention}卡牌{}作为通用支援非常出色，前提是你能把握好它们{C:attention}反转{}的时机，一旦{C:joy_spell}额外卡组{}{C:attention}卡牌{}投入战斗，它们便势不可挡！",
                },
            }
        }
    },
