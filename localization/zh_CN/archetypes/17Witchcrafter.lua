    ...
    JoyousSpring = {
        Blurbs = {
            witch = {
                story = {
                    "{C:gold}[来自“大魔法战争”故事线]{}",
                    "在{C:joy_spell}“恩底弥翁”{}附近的商贸魔法都市中，运用各自技艺与专长，将魔法注入各种物品与工艺品的行会{C:joy_normal}“魔女术”{}，已成为街头巷尾的话题。她们魔法制品的精巧创意，甚至引起了{C:joy_normal}“神圣魔导王”{}本人的注意。",
                },
                gameplay = {
                    "一旦你获得{C:joy_normal}魔女术{}，就能以一些{C:tarot}塔罗牌{}为代价，获得游戏中最出色的资源循环之一！",
                    "{C:red}提示{}: 在完成循环前使用{C:joy_effect}“魔女术工匠·宝石女巫”{}的能力，即可永续运转！"
                }
            }
        }
    },
