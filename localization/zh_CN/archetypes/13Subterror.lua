        ...
        Joker = {
            ...
            j_joy_sub_defender = {
                ...
                text = {
                    ...
                    {
                        "出售此牌可{C:attention}反转{}所有牌为表侧表示",
                    },
                }
            },
            j_joy_sub_archer = {
                name = "{C:joy_effect}地中族射手",
                text = {
                    {
            ...
            j_joy_sub_guru = {
                ...
                text = {
                    ...
                    {
                        "选择{C:attention}盲注{}时{C:attention}反转{}为表侧",
                        "{s:0.9,C:inactive}(即使里侧状态也生效)",
                    },
                }
            },
            j_joy_sub_stygo = {
                ...
                text = {
                    ...
                    },
                    {
                        ...
                        "击败{C:attention}首领盲注{}时{C:attention}反转{}",
                        "{s:0.9,C:inactive}(即使里侧状态也生效)",
                    },
                }
            },
            ...
            j_joy_sub_volt = {
                ...
                text = {
                    ...
                    {
                        "{C:joy_effect}反转{}：{C:attention}反转{}所有手牌为里侧（并洗牌）",
                    },
                    {
                        "获得时{C:attention}反转{}为里侧",
                        "选择{C:attention}首领盲注{}时{C:attention}反转{}",
                        "{s:0.9,C:inactive}(即使里侧状态也生效)",
                    },
                }
            },
            j_joy_sub_stala = {
                name = "{C:joy_effect}地中族邪界兽·直布油岩兽",
                text = {
                    {
                        "{C:joy_effect}反转{}：抽{C:attention}#1#{}张里侧牌",
                    },
                    {
                        "获得时{C:attention}反转{}为里侧",
                        "选择{C:attention}首领盲注{}时{C:attention}反转{}",
            ...
            j_joy_sub_speleo = {
                name = "{C:joy_effect}地中族邪界兽·埃琴磁魔神",
                text = {
                    {
                        "每{C:attention}反转{}1张牌获得{X:mult,C:white}X#1#{}倍率",
                        "{s:0.9,C:inactive}(即使里侧状态也生效)",
