    ...
    descriptions = {
        Joker = {
            j_joy_dogma_ecclesia = {
                ...
                text = {
                    {
                        "每售出1张{C:joy_spell}额外卡组{}的{C:attention}卡牌{}",
                ...
                text = {
                    {
                        ...
                        "{C:attention}#1#{}张随机{C:joy_spell}额外卡组{}卡牌{}",
            ...
            j_joy_dogma_albazoa = {
                ...
                text = {
                    {
                        "选择{C:attention}盲注{}时",
                        "将{C:attention}#1#{}张{C:attention}卡牌{}的副本",
            ...
            j_joy_dogma_nation = {
                ...
                text = {
                    ...
                    {
                        "可解放{C:attention}#3#{}张{C:joy_spell}额外卡组{}卡牌{}",
    ...
    JoyousSpring = {
        Blurbs = {
            dogma = {
                story = {
                    "{C:gold}[来自“彼岸”故事线]{}",
                    "{C:joy_spell}“教导国”{}是一片受神眷顾的土地，坐落于大陆的极北之地。赐予其人民的圣痕赋予宿主特殊力量，被人们称作奇迹。那些拥有格外强大奇迹之力的人加入了光荣的{C:joy_normal}“教导的骑{C:joy_normal}士”{}，与没有圣痕的异端战斗，例如兽人或妖精。",
                },
                gameplay = {
                    "通过牺牲{C:joy_spell}额外卡组{}的{C:attention}卡牌{}获取力量。召唤{C:joy_ritual}仪{C:joy_ritual}式{}以获得更大优势！"
                }
            }
        }
    },
