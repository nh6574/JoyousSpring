        ...
        Other = {
            joy_credits = {
				...
				text = {
					...
					"{C:attention}Français:{} Keraloon",
					" ",
					"{C:joy_mod}Idées Archétypes:{}",
					"{C:joy_link}@Ignister{}: gyro/rina",
					" ",
					"Quelques idées prit de ces mods:",
					...
					" ",
					"{C:joy_mod}Remerciements spéciaux{} pour les personnes",
					"des serveurs Discord {C:joy_mod}JoyousSpring{} et {C:attention}Balatro{} <3"
				}
			},
        },
    },
