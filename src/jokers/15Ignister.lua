...
JoyousSpring.Joker({
    ...
    joy_glossary = { "send", "enter", "revive", "material" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                is_tuner = true,
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "revive", "extradeck_joker", "material" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "EARTH",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "revive", "enter", "material", "extradeck" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "DARK",
        ...
        if JoyousSpring.used_as_material(card, context) and JoyousSpring.is_monster_type(context.joy_card, "Cyberse") then
            for i = 1, card.ability.extra.adds do
                JoyousSpring.add_to_extra_deck_pseudorandom(
                    { { monster_archetypes = { "Ignister" } } }, card.config.center.key, true, true)
            end
        end
    end,
    add_to_deck = function(self, card, from_debuff)
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "tribute", "revive", "summon", "extradeck_joker" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "DARK",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "summon", "extradeck_joker" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "DARK",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "extradeck", "enter", "summon", "material" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "WATER",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "enter", "material", "revive", "maindeck" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "DARK",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "maindeck", "material", "banish" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                is_field_spell = true,
                    ...
                    if (type(joker) == "string" and JoyousSpring.is_material_center(joker, { monster_archetypes = { "Ignister" } })) or JoyousSpring.is_monster_archetype(joker, "Ignister") then
                        for i = 1, card.ability.extra.creates do
                            JoyousSpring.add_monster_tag_pseudorandom(
                                { { monster_archetypes = { "Ignister" }, is_main_deck = true } }, card.config.center.key)
                        end
                        break
                    end
                end
