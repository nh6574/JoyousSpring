...
JoyousSpring.Joker({
    ...
    joy_glossary = { "extradeck_joker", "maindeck" },
    config = {
        extra = {
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "send", "revive", "material" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "EARTH",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "extradeck", "material" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "LIGHT",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "material", "link", "maindeck" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "fieldspell", "graveyard" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                is_flip = true,
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "revive", "synchro", "enter" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                is_tuner = true,
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "extradeck_joker", "banish" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "DARK",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "extradeck_joker", "enter" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "WIND",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "maindeck", "send", 'revive' },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "WATER",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "material", "synchro", "normal", "token" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                is_tuner = true,
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "excavate", "tribute", "maindeck" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "EARTH",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "excavate", "graveyard", "material", "maindeck" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "EARTH",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "graveyard", "attach", "xyz_material", "xyz" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "WIND",
