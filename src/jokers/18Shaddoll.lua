...
JoyousSpring.Joker({
    ...
    joy_glossary = { "revive", "send", "material", "fusion" },
    config = {
        extra = {
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "banish", "material", "fusion" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                is_flip = true,
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "send", "material", "fusion" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                is_flip = true,
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "graveyard", "extradeck", "material", "fusion" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                summon_type = "FUSION",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "send", "extradeck", "material", "fusion" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                summon_type = "FUSION",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "flip", "extradeck", "material", "fusion" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                summon_type = "FUSION",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "send", "revive", "fusion" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                is_field_spell = true,
