...
JoyousSpring.Joker({
    ...
    joy_glossary = { "send", "maindeck", "graveyard", "enter", "revive" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "FIRE",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "tribute", "token", "maindeck" },
    joy_desc_cards = {
        { properties = { { monster_archetypes = { "Generaider" } } }, name = "k_joy_archetype" },
    },
    config = {
