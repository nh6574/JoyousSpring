...
local ba_die = function()
    if G.GAME.modifiers.joy_ba_no_die or next(SMODS.find_card("j_joy_ba_malacoda")) or next(SMODS.find_card("j_joy_ba_cherubini")) or next(SMODS.find_card("j_joy_ba_pilgrim")) or next(SMODS.find_card("j_joy_ba_virgil")) or next(SMODS.find_card("j_joy_ba_dante")) or next(SMODS.find_card("j_joy_ba_beatrice")) then
        return false
    end
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "graveyard", "monster" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "DARK",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "graveyard", "send", "monster" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "DARK",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "special", "enter", "monster" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                attribute = "DARK",
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "monster", "extradeck" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                is_tuner = true,
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "graveyard", "send", "revive", "extradeck" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                summon_type = "XYZ",
