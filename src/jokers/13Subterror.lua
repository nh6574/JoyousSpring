...
JoyousSpring.Joker({
    ...
    joy_glossary = { "banish", "facedown", "enter" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                is_flip = true,
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "graveyard", "send", "facedown", "enter" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                is_flip = true,
...
JoyousSpring.Joker({
    ...
    joy_glossary = { "facedown", "material" },
    config = {
        extra = {
            joyous_spring = JoyousSpring.init_joy_table {
                summon_type = "LINK",
